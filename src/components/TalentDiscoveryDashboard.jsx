  ...
  const HeroNavbar = () => {
    ...
    return (
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out ${
        scrolled 
          ? 'py-3 bg-white bg-opacity-10 backdrop-blur-xl border-b border-white border-opacity-10 shadow-lg shadow-black/5' 
          : 'py-6 bg-transparent'
      }`}>
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center group">
              <div className="relative">
                <div className={`absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-400 rounded-xl blur-lg opacity-0 group-hover:opacity-20 transition-all duration-500 transform ${
                  scrolled ? 'scale-100' : 'scale-110'
                }`}></div>
                <div className="relative h-10 w-10 flex items-center justify-center bg-white bg-opacity-95 backdrop-blur-sm rounded-xl shadow-lg transform group-hover:scale-105 transition-all duration-300">
                  <img src="/logo.png" alt="Talent Discovery" className="h-6 w-auto" />
                </div>
              </div>
              <div className="ml-4">
                <span className="text-white font-bold text-xl tracking-tight bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent">
                  Talent Discovery
                </span>
                <div className="h-0.5 bg-gradient-to-r from-orange-500 to-transparent w-0 group-hover:w-full transition-all duration-500 mt-0.5"></div>
              </div>
            </div>

            {/* Desktop Navigation */}
            <div className="hidden lg:flex items-center">
              <div className="flex items-center space-x-1 bg-white bg-opacity-10 backdrop-blur-sm rounded-full px-2 py-2 border border-white border-opacity-20">
                {navLinks.map((link, index) => (
                  <a
                    key={link.href}
                    href={link.href}
                    className="relative px-5 py-2.5 text-gray-200 hover:text-white transition-all duration-300 rounded-full group font-medium text-sm"
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
                    <span className="relative z-10">{link.label}</span>
                    <div className="absolute inset-0 bg-white bg-opacity-0 group-hover:bg-opacity-15 rounded-full transition-all duration-300 transform scale-95 group-hover:scale-100"></div>
                    <div className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-orange-400 to-pink-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 rounded-full"></div>
                  </a>
                ))}
              </div>
              ...
              <div className="ml-6 flex items-center space-x-4">
                <button 
                  ...
                  className="group relative overflow-hidden bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-3 rounded-full font-semibold text-sm transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-orange-500/25"
                >
            ...
            <div className="lg:hidden">
              <button 
                ...
                className="relative p-2 text-white bg-white bg-opacity-10 backdrop-blur-sm rounded-xl border border-white border-opacity-20 hover:bg-opacity-20 transition-all duration-300"
              >
                <div className="w-6 h-6 flex flex-col justify-center items-center">
                  <div className={`w-5 h-0.5 bg-white transition-all duration-300 transform ${
          ...
          <div className={`lg:hidden overflow-hidden transition-all duration-500 ease-out ${
            ...
            <div className="mt-6 bg-white bg-opacity-10 backdrop-blur-xl rounded-2xl border border-white border-opacity-20 shadow-xl shadow-black/10">
              <div className="p-6 space-y-1">
                {navLinks.map((link, index) => (
                  <a
                    ...
                    className="flex items-center justify-between px-4 py-3 text-gray-200 hover:text-white hover:bg-white hover:bg-opacity-10 rounded-xl transition-all duration-300 group"
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
                ...
                <div className="pt-4 mt-4 border-t border-white border-opacity-20">
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-orange-500/25"
                  >
                    Sign In
                  </button>
                </div>
