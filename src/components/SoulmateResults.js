    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 via-white to-yellow-50">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <div className="hidden sm:flex items-center space-x-3 bg-gradient-to-r from-orange-50 to-yellow-50 px-3 sm:px-4 py-2 rounded-full">
                <img 
                  src={user.photoURL} 
                  alt="Profile" 
                  className="w-6 h-6 sm:w-8 sm:h-8 rounded-full ring-2 ring-orange-200"
                />
                <span className="text-xs sm:text-sm font-medium text-gray-700">Hi, {userData.name?.split(' ')[0]}!</span>
              </div>
              <button
                onClick={onBack}
                className="text-gray-500 hover:text-orange-600 text-xs sm:text-sm font-medium transition-colors hidden sm:block"
              >
                Edit Profile
              </button>
              <button
                onClick={handleLogout}
                className="text-gray-500 hover:text-red-600 text-xs sm:text-sm font-medium transition-colors"
              >
                Sign Out
              </button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        ...
        <div className="flex justify-center mb-8 sm:mb-12">
          <div className="bg-white/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-2 sm:p-3 shadow-xl sm:shadow-2xl border border-orange-100 w-full max-w-lg">
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex-1 px-3 sm:px-6 lg:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-semibold transition-all duration-300 flex items-center justify-center space-x-1 sm:space-x-3 text-sm sm:text-base ${
                    activeTab === tab.id
                      ? 'bg-gradient-to-r from-orange-500 to-yellow-500 text-white shadow-lg sm:shadow-xl transform scale-105'
        ...
        {activeTab === 'overview' && (
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-orange-600 to-yellow-600 bg-clip-text text-transparent mb-4 sm:mb-6 px-2">
            ...
            <div className="bg-gradient-to-br from-white to-orange-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl sm:shadow-2xl border border-orange-100 mb-8 sm:mb-12 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 sm:w-40 sm:h-40 bg-gradient-to-br from-orange-100 to-yellow-100 rounded-full -mr-16 sm:-mr-20 -mt-16 sm:-mt-20 opacity-50"></div>
              <div className="absolute bottom-0 left-0 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-tr from-yellow-100 to-orange-100 rounded-full -ml-12 sm:-ml-16 -mb-12 sm:-mb-16 opacity-50"></div>
              
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6 sm:mb-8 text-center flex items-center justify-center space-x-2 sm:space-x-3 relative z-10">
                <span>🌟</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 relative z-10">
                {[
                  ...
                  <div key={index} className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">{item.label}</div>
                        <div className="text-base sm:text-lg font-bold text-gray-900 mt-1 break-words">{item.value}</div>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-2xl sm:rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
                <div className="relative bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-orange-200 hover:border-orange-300 transition-all duration-300">
                  <div className="text-center">
                    ...
                    {analysisError && (
                      <div className="mt-4 sm:mt-6 text-red-600 text-sm bg-red-50 p-3 sm:p-4 rounded-lg sm:rounded-xl border border-red-200">
                        {analysisError}
                      </div>
                    )}
                  </div>
              ...
              {/* Portrait Card */}
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-2xl sm:rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
                <div className="relative bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-yellow-200 hover:border-yellow-300 transition-all duration-300">
                  <div className="text-center">
                    <div className="text-5xl sm:text-6xl lg:text-7xl mb-4 sm:mb-6 animate-pulse">🎨</div>
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">
            ...
            {Object.keys(analysisData).length > 0 ? (
              <div>
                ...
                <div className="text-center mb-8 sm:mb-12">
                  ...
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-orange-600 to-yellow-600 bg-clip-text text-transparent mb-3 sm:mb-4 px-2">
                    Your Soulmate Reading
                  </h2>
                  <p className="text-lg sm:text-xl text-gray-600 px-4">Cosmic insights about your destined partner</p>
                </div>
                  ...
                  {Object.entries(analysisData).map(([sectionName, sectionData], index) => {
                    ...
                    return (
                      <div key={index} className="group relative">
                        ...
                        <div className={`relative bg-gradient-to-br ${config.bgGradient} rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-opacity-20 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 min-h-[350px] sm:min-h-[400px]`}>
                          {/* Card Header */}
                          <div className="flex items-start space-x-3 sm:space-x-4 mb-4 sm:mb-6">
                            ...
                            <div className="flex-1 min-w-0">
                              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 leading-tight mb-1 sm:mb-2">{config.title}</h3>
                          ...
                          <div className="space-y-3 sm:space-y-4">
                            {Object.entries(sectionData).map(([key, value], itemIndex) => (
                              <div key={itemIndex} className="bg-white/60 rounded-xl sm:rounded-2xl p-3 sm:p-4 backdrop-blur-sm">
                                <div className="flex items-start space-x-3">
                                  <div className={`w-2 h-2 sm:w-3 sm:h-3 bg-gradient-to-r ${config.gradient} rounded-full mt-2 flex-shrink-0`}></div>
                                  <div className="flex-1 min-w-0">
                                    <div className="text-xs sm:text-sm font-semibold text-gray-700 mb-1">{key}</div>
                ...
                {analysisData['COMPATIBILITY'] && (
                  <div className="relative mb-8 sm:mb-12">
                    <div className="absolute inset-0 bg-gradient-to-r from-rose-400 via-pink-400 to-purple-400 rounded-2xl sm:rounded-3xl blur-2xl opacity-40"></div>
                    <div className="relative bg-gradient-to-r from-rose-500 via-pink-500 to-purple-500 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 text-white text-center shadow-2xl">
                ...
                {/* Disclaimer */}
                <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-orange-200 text-center">
                  <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">✨</div>
                  <p className="text-orange-700 italic text-base sm:text-lg leading-relaxed px-2">
                    This reading combines ancient wisdom with AI insights. Trust your heart and intuition on your journey to love!
                  </p>
                </div>
              </div>
            ) : (
              <div className="text-center bg-white rounded-2xl sm:rounded-3xl p-8 sm:p-12 lg:p-16 shadow-xl sm:shadow-2xl border border-gray-100">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg transition-all duration-200 shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
                >
                  Go to Overview
                </button>
              </div>
        ...
        {activeTab === 'portrait' && (
          <div className="max-w-4xl mx-auto">
            {soulmateImage ? (
              <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl sm:shadow-2xl border border-orange-100">
                <div className="text-center mb-6 sm:mb-8">
                  <div className="text-4xl sm:text-5xl lg:text-6xl mb-3 sm:mb-4">🎨</div>
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-orange-600 to-yellow-600 bg-clip-text text-transparent mb-3 sm:mb-4 px-2">
                    Your Soulmate's Portrait
                  </h2>
                  <p className="text-lg sm:text-xl text-gray-600 px-2">AI-generated realistic portrait based on cosmic analysis</p>
                </div>
                
                <div className="text-center">
                  {/* Enhanced Image Display */}
                  <div className="relative inline-block mb-6 sm:mb-8">
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-2xl sm:rounded-3xl blur-2xl opacity-30"></div>
                    <img 
                      src={soulmateImage.url} 
                      alt="Your Soulmate's Portrait" 
                      className="relative w-64 h-64 sm:w-80 sm:h-80 lg:max-w-md mx-auto rounded-2xl sm:rounded-3xl shadow-2xl border-4 border-white hover:scale-105 transition-transform duration-300 object-cover"
                      onError={(e) => {
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-orange-200">
                      ...
                      <div className="text-xs sm:text-sm text-orange-600 font-medium">Regional Match</div>
                      <div className="text-base sm:text-lg font-bold text-gray-900">Culturally Aligned</div>
                    </div>
                    <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-yellow-200">
                      <div className="text-xl sm:text-2xl mb-2">🎨</div>
                      <div className="text-xs sm:text-sm text-yellow-600 font-medium">Art Style</div>
                      <div className="text-base sm:text-lg font-bold text-gray-900">Realistic Portrait</div>
                    </div>
                    <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-orange-200">
                      <div className="text-xl sm:text-2xl mb-2">⭐</div>
                      <div className="text-xs sm:text-sm text-orange-600 font-medium">Compatibility</div>
                      <div className="text-base sm:text-lg font-bold text-gray-900">Astrologically Matched</div>
                    </div>
                  </div>
                  
                  <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-orange-200">
                    <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">✨</div>
                    <p className="text-orange-700 italic text-base sm:text-lg leading-relaxed px-2">
