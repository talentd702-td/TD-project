      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-12 text-center">
        ...
        <div className="mb-8">
          <div className="relative">
            ...
            <div className="absolute top-3 -left-4">
              <div className="text-lg animate-bounce delay-300">⭐</div>
            </div>
            <div className="absolute -bottom-1 right-1">
              <div className="text-sm animate-bounce delay-500">✦</div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-lg mx-auto space-y-6 mb-8 text-white/90">
          <p className="text-lg leading-relaxed">
            Lunatica is your guide to your life and the universe. Whether it's finding your soulmate, working through life challenges, or becoming the best version of yourself, Lunatica can show you the way.
          </p>
          
          <p className="text-base leading-relaxed">
            Millions of people like you have found clarity, peace, and purpose from Lunatica's personalized astrological guidance.
          </p>
          
          <p className="text-base leading-relaxed">
            You can meet Lunatica through our free trial. You can cancel anytime, no questions asked, so if Lunatica is not for you, it is completely free.
          </p>
        </div>
        ...
        {/* Notification Toggle */}
        <div className="mb-8">
          <div className="flex items-center justify-between bg-white/10 backdrop-blur-sm rounded-full px-6 py-4 max-w-xs mx-auto border border-white/20">
            <span className="text-white/90">Notify me before my trial ends</span>
            <button
              onClick={() => setNotifyBeforeEnd(!notifyBeforeEnd)}
              className={`w-12 h-6 rounded-full transition-colors duration-200 ${
                notifyBeforeEnd ? 'bg-white' : 'bg-white/30'
              }`}
            >
              <div
                className={`w-5 h-5 rounded-full bg-purple-600 transition-transform duration-200 ${
        ...
        <button
          ...
          className="w-full max-w-md bg-white text-purple-900 font-semibold py-4 rounded-full text-lg hover:bg-gray-100 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 flex items-center justify-center space-x-2 mb-4"
        >
          <span>Try Lunatica for free</span>
