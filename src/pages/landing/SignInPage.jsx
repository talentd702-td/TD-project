...
// ⚠️ Skip SSR on Vercel – render nothing during prerender
export default function SignInPage({ setIsSignedIn }) {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #003566 0%, #001122 100%)",
      }}
    >
      {/* Background effects */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-20 left-10 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse"
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl p-8">
          <div className="text-center mb-8">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #FF4500 0%, #FF6A33 100%)",
